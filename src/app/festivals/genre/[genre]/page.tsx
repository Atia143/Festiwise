  ...
  return (
    <>
      <FestivalListingSchema 
        ...
        pageTitle={`${genreName} Music Festivals Guide`}
        pageDescription={`Complete guide to ${genreFestivals.length} ${genreName} music festivals across ${countries.length} countries`}
        pageUrl={`https://getfestiwise.com/festivals/genre/${genre}`}
      />
