...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://getfestiwise.com/cheap-music-festivals-europe-2026'
  },
  openGraph: {
    ...
    url: 'https://getfestiwise.com/cheap-music-festivals-europe-2026',
    type: 'website',
    images: [
      {
...
export default function CheapMusicFestivalsEurope2026() {
  return (
    <>
